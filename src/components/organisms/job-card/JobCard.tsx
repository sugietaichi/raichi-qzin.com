...
const defaultDetails = new Map<"expose" | "hide", DetailInfo[]>([
    ["expose", [
        {
                ...
                <BorderArea title={"女の子ボイス"} >
                    ...
                    <Link href={`/job/${id}?fcs=girls_voice`} className="mt-3  flex items-center justify-between">
                        ...
                        <DetailCardCommentInfo
                            p={"p-1"} shootingDate={kuchikomi.shootingDate} comment={kuchikomi.comment} {...{ kuchikomi }} />
