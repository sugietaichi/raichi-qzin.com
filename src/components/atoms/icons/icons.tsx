export const IconLine = ({
    ...
    return (
        <svg className={`${h} ${w}`} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
...
export const IconDocText = ({
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={`${h} ${w}`}>
...
export const IconHeart = ({
    ...
    return (
        <svg
            ...
            stroke={stroke}
            fill={fill}
            className={`${w} ${h} ${m} transition duration-300`}
        >
...
export const IconBack = ({
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="black" className={`${h} ${w}`}>
            <path stroke-linecap="round" strokeLinejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3" />
        </svg>
    )
}
