...
export const ButtonItem = (
    {
        ...
        /** ボタンの外枠の丸み */
        round?: "rounded-s-lg" | "rounded-e-lg" | "rounded"
        /** ボタン背景色 */
        bgColor?: "bg-green-500" | "bg-red-500" | "bg-white" | "bg-red-300" | "bg-gray-100" | "bg-blue-400" | "bg-gray-300" | "bg-green-300" | "bg-blue-500" | "bg-blue-600"
        /** ボタン文字色 */
        textColor?: "text-white" | "text-black"
        /** FLEX値 1: 要素の幅によらず範囲を均一にする */
        flex?: "flex-1"
        /** ボタンのicon */
